...
| Convergence | Không dùng | N/A | N/A | Cả nhóm tự ngồi tranh luận trực tiếp trên Discord vì chỉ con người mới cảm nhận được độ "chạm" và năng lực thực thi của nhóm. |
...
| Rule / Workflow / Agent | Không dùng | N/A | N/A | Tự vận dụng kiến thức buổi học để phân tích: bài toán có đa biến số ngẫu nhiên thời gian thực nên Rule và Workflow đều bất lực, bắt buộc phải dùng Agent. |
| Decision | Không dùng | N/A | N/A | Cả nhóm tự thảo luận dựa trên nguồn lực thật để chốt Go ở mức Pilot có kiểm soát, tự lên kịch bản test trên vé bay thật của bạn bè. |
